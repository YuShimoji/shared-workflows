...
| コアルール | `prompts/orchestrator/modules/00_core.md` |
| フェーズモジュール | `prompts/orchestrator/modules/P0〜P6_*.md` |
...
| 1.75 | Gate | `P1.75_gate.md` |
| 2 | 状況把握 | `P2_status.md` |
| 3 | 分割と戦略 | `P3_strategy.md` |
| 4 | チケット発行 | `P4_ticket.md` |
| 5 | Worker 起動 | `P5_worker.md` |
| 6 | レポート | `P6_report.md` |
