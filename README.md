...
- **ルール本体**: `docs/Windsurf_AI_Collab_Rules_v2.0.md` 🆕
...
4. AI に v2.0 ルールを参照させる

## 関連リンク

- [Windsurf AI 協調開発ルール v2.0](./docs/Windsurf_AI_Collab_Rules_v2.0.md)
- [変更履歴](./docs/Windsurf_AI_Collab_Rules_v2.0.md#変更履歴)
